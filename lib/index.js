...
async function getToken(post_data) {
    var options = {
        payload: post_data,
        hostname: OPTIONS.GITHUB_HOSTNAME || 'github.com'
    }
...
async function getUser(access_json) {
    var options = {
        ...
        hostname: OPTIONS.GITHUB_API_HOSTNAME || 'api.github.com'
    }
...
const getLoginUrl = function () {
    var params = {
        client_id: OPTIONS.GITHUB_CLIENT_ID,
        redirect_uri: OPTIONS.BASE_URL + OPTIONS.GITHUB_AUTH_REDIRECT_URL,
        scope: OPTIONS.SCOPE,
...
exports.plugin = {
    ...
    register: async function (server, options) {
        ...
        server.route([
            {
                method: 'GET',
                path: OPTIONS.GITHUB_AUTH_REDIRECT_URL,
                config: { auth: false },
